...
cirights <- read_excel("../../Data/CIRIGHTS/cirights-v1.25.22.11/CIRIGHTS V1.25.22.11/cirights_v1.22.11.25.xlsx") |>
  filter(country == "Afghanistan", year > 2006) |>
  select(year, physint_sum, polpris:kill)
...
# Output data
d |>
  select(Year, "Physical Integrity Index" = physint_sum) |>
  filter(Year < 2018) |>
