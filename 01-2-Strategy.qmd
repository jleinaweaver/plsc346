...
2. Decide on bonus points for each game
    ...
    - Survive or die survival pool (pool points TBD by size of WC)
...
**SLIDE**: Let's attack this concept by playing a game most of you played with me already in International Relations with a slight tweak.
...
In IR, I had you play a version of this game.

- This general structure is meant to represent a very state-focused version of international politics

<br>

I like this game as a way to introduce and challenge the key assumptions in the realist paradigm.

- States colliding with each other in pursuit of their interests where violence is the key to increasing benefits

- Obviously, this is a very limited view of where benefits come from in international politics.

<br>

Now, in this class our interest is much more on unpacking the strategic lives of individuals, groups and the government

- Violence is not the only path to benefit, but it does have the capability of changing the dynamics dramatically!

<br>

**SLIDE**: So, let's tweak the game a bit for our purposes
...
**Game: Accessing and Distributing Benefits**
...
- Everyone starts with one playing card
- RPS challenges at any time to take **ONE** card (no refusals)
- You must have a card to make a challenge

::::

::: notes

Just like the last game, this one keeps the basic PvP format

- e.g. violence exists and can be used as a tool to achieve your ends

<br>

**SLIDE**: But the real game is focused on group decision-making
...
- The class distributes a pool of bonus points
- Only those with &#8805; **TWO** cards can receive points

::::

::: notes

The main object of this game is for you, as a class, to distribute a pool of bonus points among yourselves.

- When that task is done the game is over
...
Ok, you have X points to distribute (*One point per person in class?*).
...
An ultimatum is a final demand attached to a threat

- e.g. take this offer or else!

<br>

Ok, line on my left is player 1.

- P1's take a post-it note and write down each of your names on the paper with space next to each

<br>

The game is simple: You will split five bonus points between you

1. P1: Your job is to offer P2 an ultimatum (e.g. HOW you would like to divy the points)

    - e.g. offer P2 0, 1, 2, 3, 4 or 5, it's up to you!

2. P2: You may either accept the ultimatum OR refuse and BOTH SIDES GET NOTHING
...
- There are NO PRE-GAME NEGOTIATIONS! No talking!
...
- P1 write down your proposal on the post-it note then hand it to P2

- P2 make your decision and get ready to report back to the class
