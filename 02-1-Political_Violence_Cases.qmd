...
"Measurement" here is a big umbrella term including:

1. Identifying the concepts we are interested in,

2. Producing operational definitions for those concepts,

3. Developing and applying instruments to produce data! 

<br>

Big idea: This is the process by which ALL scientific knowledge is developed!

- This is not just specific to this class or to the social sciences

- ALL SCIENTIFIC KNOWLEDGE

<br>

Interested in learning about space (e.g. gravity, dark matter, black holes)? Or the development of biological life?

- You have to first decide what to measure, then how to measure, then actually do the measuring!

<br>

Learning to think about the world in terms of measurement and data is level 1 of science

- Recognizing this is how you develop expertise in a subject

- All empirical observation is created through measurement, and

- ALL measurement is uncertain

- THAT is the first reason all conclusions are uncertain and why we must be transparent in our methods

- Good science makes clear all the ways you could be wrong!
...
**SLIDE**: We are also interested in doing level 2 science in this class!
...
Big picture, remember, everything you observe in the world is a combination of the natural processes that pushed it and your own imprecise ability to observe it

- Our big aim this semester is to better understand why political violence happens

- We have to find ways to use our imprecise data to learn about the complex natural processes 
