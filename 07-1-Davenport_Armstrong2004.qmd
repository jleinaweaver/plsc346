...
- **How does the paper define "repression"?**

    - **Is the use of "repression" a leading or normative choice? e.g. implies the outcomes to be explained are bad, right?**

- **How does the paper define "democracy"?**

- **How do they make the argument that this paper is important? Worth reading?**
...
*ONLY AFTER their model diagrams are on the board add the next part*
...
- *Let them instroduce and step through theirs, THEN show your version*
...
## All Steps Lead to Peace {background-image="Images/00-Leviathan_Cover_55.png" .center .smaller}
...
## Some Steps are Better Than Others {background-image="Images/00-Leviathan_Cover_55.png" .center .smaller}
...
## Steps of Distinction {background-image="Images/00-Leviathan_Cover_55.png" .center .smaller}
...
- Read and submit your analyses of the models on Canvas

::: notes

Next class a different approach to explaining the use of political violence by democratic governments
