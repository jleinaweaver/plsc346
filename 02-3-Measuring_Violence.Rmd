...
to revise: Each group must create two instruments

1. a nominal measure (Yes vs no this meets our definition), and 

2. an ordinal (If yes is the amount low, medium or high). 
