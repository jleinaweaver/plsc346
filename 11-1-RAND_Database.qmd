...
2. Links and files
    ...
    - [Definitions](https://www.rand.org/nsrd/projects/terrorism-incidents/about/definitions.html)
    - [Coverage](https://www.rand.org/nsrd/projects/terrorism-incidents/about/coverage.html)
    - File: RAND_Database_of_Worldwide_Terrorism_Incidents.xlsx

<br>

**SLIDE**: Last week we worked to deepen our understanding of terrorism as a contested concept
...
Catch me up on our work so far!

- **What are the key takeaways of our work trying to define terrorism?**
...
- If terror as a strategy is frequently justified on moral grounds, then we'd better explore the language and rationales for it.
