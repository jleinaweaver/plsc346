...
.size40[1) How consistent are these two sources on each country?]
...
.size40[2) Do the sources focus on the same things? How redundant are they?]
...
.size40[3) How independent are the two sources?]
