...
2. Prep a Google sheet for unpacking cases and publish on Canvas

3. Markers x 5
    
4. Save notes from today for next class (e.g. end of class operationalization elements need to go into slides for next class)
...
::: {.r-fit-text}
[**The Characteristics of "Terrorism"**]{style="color:white;"}
:::

<br>

[**What are the most common or consistent characteristics of "terrorism" across these cases?**]{style="color:white;"}


::: notes

GROUPS, compare and contrast all of the cases in order to identify the **characteristics of terrorism**

- In a sense, ask yourself what is common or most important to the cases unpacked by our class?
...
- Let's go! Get those characteristics up on the board!
...
Groups, go back to your list

- Anything you want to add from the other groups?

- Anything beyond our submitted cases that you'd like to include as characteristics of terrorism as you think about it
...
::: {.r-fit-text}
**Propose an Operational Definition of Terrorism**

<br>

**Terrorism is...**

- Select observable phenomena
