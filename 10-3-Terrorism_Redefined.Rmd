...
With a few days to reflect on our work we need a working definition of terrorism!

### What do we have?

### What obervable phenomena can we tie to it?

*ON BOARD: Definition and Observable Phenomena*

<br>

### Notes from prior semesters
...
I think this Jaggar article you read for today introduces some really important ideas we need to consider in both defining terrorism and undertsanding it as a strategy.

*Read the quote on screen*

I'm certainly not advancing any of these complications as an argument that it represents the RIGHT way to think about terrorism.

Our job as social scientists is to be familiar with the many competing narratives that exist so we can explain and predict the behavior of actors in the world.

<br>

Let's build up to the Jagger article for today by examining four perspectives on terrorism that complicate the definitional challenge.
...
Perspective on Terrorism 1: "One person’s terrorist is another person’s freedom fighter"
...
This matters for thinking about terrorism as a strategy

- Every person has lines they will not cross,

- Every person has some justification or rationalization for their behavior.
...
### What does this mean and how does it frame terrorism for us?
...
- Perspective 2 argues terrorism is NOT AT ALL subjective. It is based on context and norms.
...
### Do we buy this? What does it mean for our definition if we do?
- Our definition must adjust to whatever the local conditions are in a state
- And yes that means people living under brutal regimes are bound by the rules of those regimes (the functioning society)
...
This perspective on terrorism pervades many modern debates in the US and has been used to justify some truly messed up acts.

### Does this bring us back to the subjectivity problem of Perspective 1 or is this black-and-white framing something new?
