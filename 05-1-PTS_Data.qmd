...
## Concept: "Political Terror" {background-image="Images/00-Leviathan_Cover_55.png" .center}
...
**First, are we comfortable classifying all of these sources as measures of "political violence"?**

<br>

**Second, do these two approaches cover different conceptual ground or are they essentially synonymous?**

:::



## Concept: "Political Terror" {background-image="Images/background-light_grey.jpg" .center}
...
*ON BOARD - Class Fall 2025*

Valid and Reliable

- Operational definitions explicit and specific
- Multiple reports, aims for credible
...
- Biased sources, biased results
- Depends on a healthy news media
- Five point scale is too blunt a tool
    - Multiple paths to any one score, hard to differentiate
- Unclear weighting
- Limited to violence inside state's territory
- Only level 5 introduces violence against the wider population (e.g. not targeted)
- When a threshold isn't quite crossed the coders are supposed to err on the side of the lower score
