...
### Prep for Class
1. Prep email with link to Google Sheet to claim cases for Friday
...
Ok, let's briefly hear about your cases.
...
The idea is to use this table to find characteristics that correlate with the outcome.
...
However, our goal is to brainstorm so we'll forgive ourselves this week.
...
Everybody take a few minutes to think about their own case and the cases they heard about and make a list of possible characteristics we could track.
...
Find a case of a democratic state using political violence. 

Then add it to our spreadsheet and code it for these variables. 
