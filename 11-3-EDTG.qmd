...
2. Open data exploration R file so you can follow along with the groups' work
...
## {background-image="Images/11_3-domestic_terror_v2.png"}

### [Who are the domestic terror groups currently active in the USA? (2016)]{style="color:black;"}
...
Canvas Assignment: Cases of Effective Terror Acts

Submit to Canvas a piece of evidence showing terrorism (e.g. a terrorist group, a terrorist threat or a specific terror attack) changing the behavior of a target audience (e.g. society, community, government) in some specific way.

1. Submit an APA citation to evidence of your selected act, 

2. A brief explanation of why this was terrorism, AND 

3. A brief explanation of why you believe it was "successful."
