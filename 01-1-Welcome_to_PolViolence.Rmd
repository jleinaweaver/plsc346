...
.textwhite[.size40[
**LO1 (Content Knowledge)**: Students should demonstrate a basic understanding of the uses of political violence by state and non-state actors at the domestic and international levels.

**LO2 (Methods Knowledge)**: Students should demonstrate their ability to use comparative and quantitative methods for testing theories of political violence.

**LO3 (Critical Thinking/Problem-Solving)**: Students should be able to evaluate strategies for reducing acts of political violence at the domestic and international levels.
]]
...
Aim: Define and explore the concepts of "strategy" and "rationality"

- The readings are short chapters from the beginning of a PHENOMENAL book on "Strategy" by Lawrence Freedman.
