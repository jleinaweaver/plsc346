...
.size60[.content-box-white[**Weber (1918/1946)**]]
...
background-image: url('libs/Images/03_1-noaa_map.gif')
background-size: 72%
background-position: center
class: slidered
...
background-image: url('libs/Images/03_1-Topographic-Map.jpg')
background-size: 66%
background-position: center
class: slidered
...
```{r, fig.align='center'}
knitr::include_graphics('libs/Images/03_1-Water-Cycle.png')
```
]
...
.pull-right[
```{r, fig.align='center'}
knitr::include_graphics('libs/Images/03_1-Gravity.jpg')
```

```{r, fig.align='center'}
knitr::include_graphics('libs/Images/03_1-Einstein_Gravity.jpg')
```
]
...
.center[.size60[**Frieden, Lake and Schultz (2016)**]]
