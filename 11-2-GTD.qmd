...
# Data for today
d <- read_excel("../../Data/GTD-Global_Terrorism_Database/2025-April-Download/GTD-Full_Dataset_1970-2020.xlsx", na = "NA", guess_max = 100000)
...
2. Files and links
    ...
    - File: GTD-Codebook2021.pdf
    - File: GTD-Full_Dataset_1970-2020.xlsx
    - File: GTD-5yr_Snapshots-1970_2020.xlsx
    - File: GTD-USA-1970_2020.xlsx
    - [About](https://www.start.umd.edu/data-tools/GTD)
    - [Methods highlights](https://www.start.umd.edu/using-gtd)
    - [FAQ](https://www.start.umd.edu/gtd-faqs)
    
3. Update RAND pros and cons list AND key takeaways in refresher slides below

<br>

**SLIDE**: RAND database reflections
...
Last class we examined the RAND Database of Worldwide Terrorism Incidents (RDWTI)

- **Focusing just on the methodology, what are the pros and cons of using this as our primary database of terrorism?**
...
- Very US government / US military focused perspective on the problem (if your goal is to view terrorism through that lens)

Cons:

- Not currently being updated
- Not clear on sourcing of data or robustness checks
- Lots of inconsistencies in the database (group names change coding)

<br>

**SLIDE**: And what does the RAND database tell us about terrorism?
...
1. Is the damage caused by terrorism getting worse over time?

2. Where are the terrorism hot spots in the world?

3. Are the characteristics of terrorism changing?

::: notes

**Refresh my memory, what were our answers to these three questions using the RDWTI?**
