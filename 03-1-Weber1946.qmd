...
- a "[**compulsory**]{style="color:red;"} association which organizes [**domination**]{style="color:red;"}"
...
- The state [**monopolizes**]{style="color:red;"} and [**defines**]{style="color:red;"} the legitimate use of force
...
- These are terrifying assumptions

<br>

**SLIDE**: Let's unpack the interactions for a moment
...
According to Weber's model, the state should use violence anytime it feels its hold on power being threatened

- Even if the threat is explicitly non-violent or small or done by a vulnerable population.

<br>


**SLIDE**: Back to the model
...
Weber is not just claiming that political violence is a tool of the state he is arguing the state IS violence.
...
**FIRST, is it logical? Why or why not?**

<br>

**SECOND, is it able to explain outcomes in the real-world? Why or why not?**

<br>

**If this is your primary model of political violence, how would that impact your day-to-day decision-making as an individual? Would it?**
...
- **Does assuming the state IS violence lead one to behave more violently thus inspiring more violence from the government?**

<br>

**SLIDE**: Let's go back to our definitions of politics from Week 1
...
Think about Weber's argument.

- **Would Weber argue that we have defined politics in a useful way? What would he say we are missing?**

- (No reference to violence...)

<br>

**Are you persuaded that a useful definition of politics requires a reference to violence? Why or why not?**

<br>

**Give it a shot, how could we redefine "politics" to include violence?**

- **Does that make the concept more useful or change its meaning entirely?**
...
- Submit model diagram to Canvas

::: notes

An alternative model explaining the state and violence!

- Read it and then submit your best diagram of the model in terms of interests, institutions and interactions
